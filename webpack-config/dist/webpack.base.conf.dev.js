...
module.exports = {
  ...
  entry: {
    ...
    index: "".concat(PATHS.src, "/assets/scss/pages/index.scss"),
    colorstypes: "".concat(PATHS.src, "/assets/scss/pages/colorstypes.scss"),
    ...
    hf: ["".concat(PATHS.src, "/hf.js"), "".concat(PATHS.src, "/assets/scss/pages/hf.scss")],
    lp: ["".concat(PATHS.src, "/lp.js"), "".concat(PATHS.src, "/assets/scss/pages/lp.scss")],
    searchroom: ["".concat(PATHS.src, "/searchroom.js"), "".concat(PATHS.src, "/assets/scss/pages/searchroom.scss")],
    roomdetails: ["".concat(PATHS.src, "/roomdetails.js"), "".concat(PATHS.src, "/assets/scss/pages/roomdetails.scss")]
  },
  output: {
  ...
  module: {
    rules: [{
      ...
      use: ["style-loader", MiniCssExtractPlugin.loader, {
        ...
        options: {
          resources: "".concat(PATHS.src, "/assets/scss/utils/vars.scss")
        }
      }]
    }, {
      test: /\.css$/,
  ...
  plugins: [new webpack.ProvidePlugin({
    ...
    return new HtmlWebpackPlugin({
      ...
      chunks: ["".concat(page.replace(/\.pug/, ''))]
    });
  })))
};